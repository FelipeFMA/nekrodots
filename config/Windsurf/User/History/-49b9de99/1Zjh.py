...
class WiFiNetworkRow(Gtk.ListBoxRow):
    def __init__(self, network_info):
        ...
        if signal_value >= 80:
            icon_name = "network-wireless-signal-excellent-symbolic"2025-03-18 14:56:31,506 [INFO] Better Control is running.
ok
Connection successfully activated (D-Bus active path: /org/freedesktop/NetworkManager/ActiveConnection/18)
Traceback (most recent call last):
  File "/home/felipe/Downloads/message.py", line 1947, in connect_wifi
    self.refresh_wifi()
    ~~~~~~~~~~~~~~~~~^^
TypeError: bettercontrol.refresh_wifi() missing 1 required positional argument: 'button'
